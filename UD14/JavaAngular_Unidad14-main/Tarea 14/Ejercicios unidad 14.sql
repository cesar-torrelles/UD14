CREATE DATABASE  IF NOT EXISTS `películas_salas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `películas_salas`;
...
CREATE TABLE `salas` (
  ...
  CONSTRAINT `salas_ibfk_1` FOREIGN KEY (`Codigo_pelicula`) REFERENCES `peliculas` (`Codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-19 16:43:38
...
-- Dump completed on 2021-02-19 16:43:39
...
CREATE TABLE `muestra` (
  ...
  `velocidadminima` smallint unsigned DEFAULT NULL,
  `velocidadmaxima` smallint unsigned DEFAULT NULL,
...
-- Dump completed on 2021-02-19 16:43:39
CREATE DATABASE  IF NOT EXISTS `bd_tiendainformatica` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Dump completed on 2021-02-19 16:43:40
CREATE DATABASE  IF NOT EXISTS `bd_cientificos` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_cientificos`;
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
...
-- Dump completed on 2021-02-19 16:43:40
CREATE DATABASE  IF NOT EXISTS `bd_directores` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_directores`;
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
...
CREATE TABLE `alumnos` (
  ...
  `curso` int NOT NULL,
  PRIMARY KEY (`DNI`),
  CONSTRAINT `alumnos_chk_1` CHECK (((`Sexo` = _utf8mb4'H') or (0 <> _utf8mb4'M')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cursos` (
  ...
  CONSTRAINT `cursos_chk_1` CHECK ((`fecha_fin` > `fecha_inicio`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-19 16:43:41
...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`Departamento`) REFERENCES `departamentos` (`Código`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-19 16:43:41
CREATE DATABASE  IF NOT EXISTS `bd_investigadores` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `almacenes` (
  `codigo` int NOT NULL AUTO_INCREMENT,
  `lugarCapacidad` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-19 16:43:42
CREATE DATABASE  IF NOT EXISTS `piezas_proveedores` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `proveedores` VALUES ('1','Proveedor 1'),('10','Proveedor 10'),('2','Proveedor 2'),('3','Proveedor 3'),('4','Proveedor 4'),('5','Proveedor 5'),('6','Proveedor 6'),('7','Proveedor 7'),('8','Proveedor 8'),('9','Proveedor 9');
...
-- Dump completed on 2021-02-19 16:43:42
CREATE DATABASE  IF NOT EXISTS `bd_almacenes` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_almacenes`;
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
-- Host: localhost    Database: bd_almacenes
-- ------------------------------------------------------
-- Server version	8.0.22
